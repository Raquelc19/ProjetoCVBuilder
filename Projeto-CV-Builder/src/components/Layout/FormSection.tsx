...
function FormSection({experiences, setExperiences, Nome, setNome, email, setEmail, telefone, setTelefone, linkedin, setLinkedin, resumoProfissional, setResumoProfissional}) {
    return(

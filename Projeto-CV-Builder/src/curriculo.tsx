function CurriculumPreview() {
  return (
    <main className="min-h-screen w-screen grid place-items-center bg-white">
      <div className="flex justify-center w-[90vw] max-w-[1200px] h-[80vh] gap-6 mx-auto">

        <section className="w-[40%] bg-white rounded-lg shadow-md flex flex-col overflow-y-auto">
          <div className="bg-purple-900 text-white p-5 text-center">
            <h1 className="text-[20px] font-bold">Informações do Currículo</h1>
          </div>
        </section>

        <section className="w-[40%] bg-white rounded-lg shadow-md flex flex-col overflow-y-auto h-full">
          <div className="bg-purple-900 text-white p-5 text-center">

  ...
  return (
    <>
      <main className="w-full h-screen px-0">
        ...
        <div className="flex flex-col lg:flex-row justify-center w-full max-w-[1200px] h-auto max-2xl:h-[75vh] min-2xl:h-[76vh] gap-6 mx-auto mt-5">
          {/* --- Formulário --- */}
          <FormSection
        ...
        <footer className="text-center text-gray-500 py-4 items-end flex h-1/12 justify-center mb-0">
          <p className="">© 2025 Devriders. Todos os direitos reservados.</p>
        </footer>
      </main>
